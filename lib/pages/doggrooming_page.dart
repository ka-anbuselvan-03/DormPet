...
class DogGroomingPage extends StatefulWidget {
  const DogGroomingPage({Key? key}) : super(key: key);

  @override
  State<DogGroomingPage> createState() => _DogGroomingPageState();
}

class _DogGroomingPageState extends State<DogGroomingPage> {
  List groomingList = [
    {
      'name': 'Spa Bath',
      'services': 7,
