...
class CatGroomingPage extends StatefulWidget {
  const CatGroomingPage({Key? key}) : super(key: key);

  @override
  State<CatGroomingPage> createState() => _CatGroomingPageState();
}

class _CatGroomingPageState extends State<CatGroomingPage> {
  List groomingList = [
    {
      'name': 'Spa Bath',
      'services': 7,
