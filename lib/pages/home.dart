          ...
          Row(
            children: [
              PetCard(
                ...
                petName: 'Cat Adoption',
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const CatGroomingPage()));
                },
              ),
              Gap(28),
              PetCard(
                ...
                height: 68,
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const DogGroomingPage()));
                },
              ),
            ],
          ),
